...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <div class="main">
      <section class="module home-section home-fade bg-dark-60" data-background="assets/images/colecao/estagiarios/col-1.jpg">
          <div class="container">
            <div class="row">
            ...
            <div class="row multi-columns-row">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-1.jpg" title="Title 1"><img src="assets/images/colecao/estagiarios/col-1.jpg" alt="Gallery Image 1"/>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-2.jpg" title="Title 2"><img src="assets/images/colecao/estagiarios/col-2.jpg" alt="Gallery Image 2"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-3.jpg" title="Title 3"><img src="assets/images/colecao/estagiarios/col-3.jpg" alt="Gallery Image 3"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-4.jpg" title="Title 7"><img src="assets/images/colecao/estagiarios/col-4.jpg" alt="Gallery Image 7"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-5.jpg" title="Title 8"><img src="assets/images/colecao/estagiarios/col-5.jpg" alt="Gallery Image 8"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-6.jpg" title="Title 9"><img src="assets/images/colecao/estagiarios/col-6.jpg" alt="Gallery Image 9"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-8.jpg" title="Title 5"><img src="assets/images/colecao/estagiarios/col-8.jpg" alt="Gallery Image 5"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image"><a class="gallery" href="assets/images/colecao/estagiarios/col-9.jpg" title="Title 6"><img src="assets/images/colecao/estagiarios/col-9.jpg" alt="Gallery Image 6"/>
                      <div class="gallery-caption">
                        <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                      </div></a></div>
                </div>
