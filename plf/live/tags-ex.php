...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="10">
    <main>
      ...
      <div class="main">
      <section class=" home-section home-fade  home-full-height  blog-page-header" data-background="assets/images/eventos.png">
          <div class="container">
            <div class="row">
            </div>
          </div>
              ...
              <div class="col-sm-8">
                <div class="post">
                  ...
                  <div class="post-header font-alt">
                    <h1 class="post-title">Colação de Grau</h1>
                    <div class="post-meta">By Nadson Nascimento | 20 de Novembro | 3 Comments | Fotografia, Estágio.
                    </div>
                  </div>
                  <div class="post-entry">
                    <p>A colação de grau é uma cerimônia solene realizada no encerramento de cursos de graduação, marcando a conclusão acadêmica dos estudantes. Durante essa cerimônia, os graduandos recebem simbolicamente o grau acadêmico que certifica a conclusão bem-sucedida de seu curso universitário. </p>
                    </blockquote>
                  </div>
                </div>
              </div>
                  ...
                  <ul class="widget-posts">
                    <li class="clearfix">
                      ...
                      <div class="widget-posts-body">
                        <div class="widget-posts-title"><a href="tags-ex.php">Colação de Grau : Direito 2023.2</a></div>
                      </div>
                    </li>
                    <li class="clearfix">
